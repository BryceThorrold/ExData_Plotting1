...
par(mfrow = c(2,2))
plot(smallertable$fulldate,smallertable$Global_active_power, type = "n", ylab = "Active Power")



plot(smallertable$fulldate,smallertable$Voltage, type = "n", ylab = "Voltage")
...
plot(smallertable$fulldate,smallertable$Global_reactive_power, type = "n", ylab = "Energy sub metering")
